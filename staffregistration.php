	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-light bg-light" >
		...
		<ul class="breadcrumb">
		  ...
		  <li><a href="loginID.php">My Account</a></li>
          <li style="color:white">/</li>
          <li><a href="teacher.php">Users</a></li>
          <li style="color:white">/</li>
...
<div class="container" style=" background-color:#ffb606;padding:80px;">
    <div class="border">
      <form name="myForm" style="background-color:white;margin:5%;border:1px solid black;padding:5px" action="createdStaffAccount.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">  
      <div class="row">
          <div class="col-sm-12">
            <h1 style="text-align:center;margin-top:50px;margin-bottom:50px">Staff Registration</h1>
          </div>
       </div>
       <div class="form-group" >
          ...
          <div class="form-group">
          <label for="staffCategory" class="col-sm-3 control-label">Saff Category <span style="color:red">*</span></label>
            <div class="col-sm-5">
              <select name="staffCategory" class="form-control-R">
                 <option value="">-Select-</option>
                 <option value="Attendance Marker">Attendance Marker</option>
