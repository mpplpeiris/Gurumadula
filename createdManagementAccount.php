...
<?php
  ...
  $managementCategory=$_POST["managementCategory"];
  $title=$_POST["title"];
  ...
  $target_dir = "images/Management/uploadProfileImage/";
  $target_file = $target_dir . basename($profileImageName);

  $GetSidNo="SELECT * FROM managerdetails";
  ...
  $sql1="INSERT INTO managerdetails(managementCategory,ID,title,firstName,middleName,lastName,DOB,nationality,religion,address,
  phoneNumber,email,qualifications,profileImage) VALUES 
  ('$managementCategory','$ID','$title','$fname','$mname','$lname','$DOB','$nationality','$religion','$address','$phoneNumber',
 ...
 $sql2="INSERT INTO login(username,position,password,active,firstName) VALUES ('$ID','Manager','$autopassword','1','$fname')";
