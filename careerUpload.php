<!-- to upload empty job position details by managers and admin-- to createdCareer.php-->
...
<html lang="en">
  <head>
    ...
    {
      document.querySelector('#flyerImage').click();
   }
    ...
    function displayImage(e) 
    {
      if (e.files[0]) 
      {
          ...
          {
            document.querySelector('#flyerDisplay').setAttribute('src', e.target.result);
          }
    ...
    function validateForm() {
         var title = document.forms["regForm"]["position"].value;
     
          if (position == "") {
            alert("Position must be filled out");
            return false;
          } 
          var keyRequirements = document.forms["regForm"]["keyRequirements"].value;
          if (keyRequirements == "") {
            alert("Key requirements name must be filled out");
            return false;
          } 
          var flyerImage =  document.forms["regForm"]["flyerImage"].value; 
          if (flyerImage == "") {
            alert("Flyer Image must be filled out");
            return false;
          }
...
<div class="container" style=" background-color: #ffb606 ;padding-top:1px;padding-bottom:5px">
  ...
  <form  name="regForm" id="regForm" action="createdCareer.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()" >
    
    <!-- First Tab My Details Starts -->                                                    
    <div class="border" style="margin-top: 2em;">
        <h1  id="header">Upload Career Opportunities</h1>
          <!---Upload Image Starts-->
           <div class="container" style="margin-bottom:0px;">
             
                <div class="row">
                         <div class="col-12 offset-md-5" style="margin-left:0;">
                            <label for="position"  class="col-sm-3 control-label"> Position:</label>
                            <div class="col-sm-12">
                                <input class="form_input" name="position" placeholder=" Position" >
                            </div>
                         </div>
                </div>
                <div class="row">
                         <div class="col-12 offset-md-5" style="margin-left:0;">
                            <label for="keyRequirements"  class="col-sm-10 control-label"> Key Requirements:</label>
                            <div class="col-sm-12">
                                <textarea class="form_input" name="keyRequirements" placeholder=" Key Requirements" style="height:400px"></textarea>
                            </div>
                         </div>
                </div>
                <div class="row">
                        <div class="col-12 offset-md-5" style="margin-left:0;">
                            <label for="uploadFlyer"  class="col-sm-7 control-label"> Upload Flyer:</label>
                        </div>
                        <div class="col-12 offset-md-5" style="margin-left:50px;">
                            <div class="form-group text-center" style="position: relative;" >
                              <span class="img-div">
                                <img src="./images/career/flyer-sign.png" onClick="triggerClick()"  id="flyerDisplay"  style="width:220px">
                              </span>
                              <input type="file"  onChange="displayImage(this)" id="flyerImage" name="flyerImage" class="form-control-R" style="display: none;">

                            </div>
                         </div>
                </div>
                <div class="row">
                       <div class="col-3 offset-md-5" style="margin-left:70%;">   
                           <input   type="submit" class="form_input button" name="submit" >
                       </div>
                </div>        
           </div>
    </div>     
