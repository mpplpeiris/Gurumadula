...
<?php
  ...
  $target_dir = "images/Staff/uploadProfileImage/";
  $target_file = $target_dir . basename($profileImageName);

  $GetSidNo="SELECT * FROM staffdetails";
  $result=query_execute($GetSidNo); 
  $rowcount=mysqli_num_rows($result);
   $invID=str_pad($rowcount,5,0,STR_PAD_LEFT);
   $year = date("Y");
   if($staffCategory=="Attendance Marker"){
    $ID="AM/".$year."/".$invID;
   }
   if($staffCategory=="Cashier"){
    $ID="CH/".$year."/".$invID;
   }
   if($staffCategory=="Administrator"){
    $ID="AD/".$year."/".$invID;
   }
  ...
  $sql1="INSERT INTO staffdetails(staffCategory,ID,title,firstName,middleName,lastName,DOB,nationality,religion,address,
  phoneNumber,email,qualifications,profileImage) VALUES 
  ('$staffCategory','$ID','$title','$fname','$mname','$lname','$DOB','$nationality','$religion','$address','$phoneNumber',
  '$email','$qualifications','$profileImageName')";
 ...
 $sql2="INSERT INTO login(username,position,firstName,password,active) VALUES ('$ID','Staff','$fname','$autopassword','1')";
...
<html lang="en">
  <head>
    <title>E-GURUMADULA staff</title>
    <meta charset="utf-8">
    ...
    <div class="modal-dialog modal-confirm" >
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">You are successfully created the account!</h4>	
			</div>
