...
<?php
   if(isset($_POST["btn-loginID"]))
   {
       ...
       $_SESSION["firstName"] = $found_acc["firstName"];
       ...
       if($found_acc)
       {
            ...
            if($_SESSION["position"]=='Student')
            {
              ...
              redirect_to("myAccountStudent.php");
            }
            ...
            { $sql = "SELECT * FROM teachersdetails WHERE ID='$username'";
              ...
              if($found)
              {
                $_SESSION["image"]=$found["profileImage"];
              }
              else
              {
                $_SESSION["image"]="upload.png";
            ...
            {$sql = "SELECT * FROM managerdetails WHERE ID='$username'";
              $rec = query_execute($sql);
              $found=mysqli_fetch_assoc($rec);
              if($found)
              {
              ...
              $_SESSION["imagePath"]="Management/uploadProfileImage";
              redirect_to("myAccountManager.php");
            }
            if($_SESSION["position"]=='Staff')
            {$sql = "SELECT * FROM staffdetails WHERE ID='$username'";
              $rec = query_execute($sql);
              $found=mysqli_fetch_assoc($rec);
              if($found)
              {
              ...
              $_SESSION["imagePath"]="Staff/uploadProfileImage";
              redirect_to("myAccountStaff.php");
            }
       }
        ...
        <?php echo success_msg();
                ...
                <form action="login.php"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" name="password" class="form-control" placeholder="Enter Your Password" onblur="validate(this)" required="required">
                    </div>
                    <div class="form-group">
