...
<?php
  ...
  $sql5="INSERT INTO login(username,position,autopassword,active,firstLoginCheck) VALUES ('$studentID','Student','$autopassword','1','0')";
    ...
    $mailMsg = "You Are Successfully Created An Account.Your ID Is ".$studentID." And Use This Password For First Login.Your Password is ".$autopassword."When You Login Change Your Password As You Like.";
